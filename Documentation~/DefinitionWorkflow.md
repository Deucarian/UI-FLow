...
3. Use its buttons to exercise open with c#, open from component, back.
4. Inspect the configured hosts and triggers, then open
   [UIFLowWorkflow.cs](../Samples~/DefinitionWorkflow/Runtime/UIFLowWorkflow.cs). It is the caller
...
- **Open with C#**: `UIFLowWorkflow.Open()`.
- **Open from component**: `UIFLowWorkflow.OpenComponent()`.
- **Back**: `UIFLowWorkflow.Back()`.
